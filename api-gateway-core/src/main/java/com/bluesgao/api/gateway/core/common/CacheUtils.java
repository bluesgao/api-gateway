...
public class CacheUtils {
    ...
    static {
        ...
        try {
            ...
            InputStream fileIs = CacheUtils.class.getClassLoader().getResourceAsStream("redis-config.properties");
            ...
            MAX_IDLE = Integer.parseInt(properties.getProperty("redis.maxidle"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
//===========================================================
    ...
    public class Keys {
         ...
         * @param key
         */
        public synchronized long expire(String key) {
         ...
         * @return 影响的记录数
         */
        public synchronized long expireAt(String key, long timestamp) {
            Jedis jedis = getJedis();
         ...
         * 更改key
         */
        public synchronized String rename(byte[] oldKey, byte[] newKey) {
            Jedis jedis = getJedis();
         ...
         **/
        public synchronized List<String> sort(String key) {
            Jedis sjedis = getJedis();
         ...
         **/
        public synchronized List<String> sort(String key, SortingParams parame) {
            Jedis jedis = getJedis();
    ...
    public class Sets {
         ...
         * @return 操作码, 0或1
         */
        public synchronized long sadd(String key, String member) {
            Jedis jedis = getJedis();
        ...
        public synchronized long sadd(byte[] key, byte[] member) {
            Jedis jedis = getJedis();
            long s = jedis.sadd(key, member);
            closeJedis(jedis);
            return s;
         ...
         * @return 差异的成员集合
         */
        public synchronized Set<String> sdiff(String... keys) {
            Jedis jedis = getJedis();
         ...
         * @return 新集合中的记录数
         **/
        public synchronized long sdiffstore(String newKey, String... keys) {
            Jedis jedis = getJedis();
         ...
         * @return 新集合中的记录数
         **/
        public synchronized long sinterstore(String newKey, String... keys) {
            Jedis jedis = getJedis();
         ...
         * @return 状态码，1成功，0失败
         */
        public synchronized long smove(String srckey, String dstkey, String member) {
            Jedis jedis = getJedis();
         ...
         */
        public synchronized long srem(String key, String member) {
            Jedis jedis = getJedis();
         ...
         * @return 合并后的结果集合
         */
        public synchronized Set<String> sunion(String... keys) {
            Jedis jedis = getJedis();
         ...
         * @param keys   要合并的集合
         **/
        public synchronized long sunionstore(String newKey, String... keys) {
            Jedis jedis = getJedis();
    ...
    public class SortSet {
         ...
         * @return
         */
        public synchronized long zlength(String key) {
            long len = 0;
         ...
         * @return Set<String>
         */
        public synchronized Set<String> zrange(String key, int start, int end) {
            // ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
         ...
         * @return Set<String>
         */
        public synchronized Set<String> zrangeByScore(String key, double min, double max) {
            // ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
         ...
         * @return 返回1成功
         */
        public synchronized long zrem(String key, String member) {
            Jedis jedis = getJedis();
         ...
         * @return
         */
        public synchronized long zrem(String key) {
            Jedis jedis = getJedis();
         ...
         * @return 删除的数量
         */
        public synchronized long zremrangeByRank(String key, int start, int end) {
            Jedis jedis = getJedis();
         ...
         * @return 删除的数量
         */
        public synchronized long zremrangeByScore(String key, double min, double max) {
            Jedis jedis = getJedis();
         ...
         * @return Set<String>
         */
        public synchronized Set<String> zrevrange(String key, int start, int end) {
            // ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
         ...
         * @return double 权重
         */
        public synchronized double zscore(String key, String memebr) {
            // ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
    ...
    public class Hash {
         ...
         * @return 状态码，1成功，0失败
         */
        public synchronized long hdel(String key, String fieid) {
            Jedis jedis = getJedis();
        ...
        public synchronized long hdel(String key) {
            Jedis jedis = getJedis();
            long s = jedis.del(key);
            closeJedis(jedis);
            return s;
         ...
         * @return 1存在，0不存在
         */
        public synchronized boolean hexists(String key, String fieid) {
            // ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
         ...
         * @return 存储对应的值
         */
        public synchronized String hget(String key, String fieid) {
            // ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
        ...
        public synchronized byte[] hget(byte[] key, byte[] fieid) {
            // ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
         ...
         **/
        public synchronized long hset(String key, String fieid, String value) {
            Jedis jedis = getJedis();
        ...
        public synchronized long hset(String key, String fieid, byte[] value) {
            Jedis jedis = getJedis();
         ...
         **/
        public synchronized long hsetnx(String key, String fieid, String value) {
            Jedis jedis = getJedis();
         ...
         */
        public synchronized long hincrby(String key, String fieid, long value) {
            Jedis jedis = getJedis();
         ...
         * @return List<String>
         */
        public synchronized List<String> hmget(String key, String... fieids) {
            Jedis sjedis = getJedis();
        ...
        public synchronized List<byte[]> hmget(byte[] key, byte[]... fieids) {
            Jedis sjedis = getJedis();
         ...
         * @return 状态，成功返回OK
         */
        public synchronized String hmset(String key, Map<String, String> map) {
            Jedis jedis = getJedis();
         ...
         * @return 状态，成功返回OK
         */
        public synchronized String hmset(byte[] key, Map<byte[], byte[]> map) {
            Jedis jedis = getJedis();
            String s = jedis.hmset(key, map);
            closeJedis(jedis);
            return s;
    ...
    public class Strings {
         ...
         * @return String 操作状态
         */
        public synchronized String setEx(byte[] key, int seconds, byte[] value) {
            Jedis jedis = getJedis();
            String str = jedis.setex(key, seconds, value);
            closeJedis(jedis);
            return str;
         ...
         * @return 状态码
         */
        public synchronized String set(byte[] key, byte[] value) {
            Jedis jedis = getJedis();
         ...
         * @return long 减指定值后的值
         */
        public synchronized long decrBy(String key, long number) {
            Jedis jedis = getJedis();
         ...
         * @return long 相加后的值
         */
        public synchronized long incrBy(String key, long number) {
            Jedis jedis = getJedis();
    ...
    public class Lists {
         ...
         * @return 状态码
         */
        public synchronized String lset(byte[] key, int index, byte[] value) {
            Jedis jedis = getJedis();
         ...
         * @return 值
         **/
        public synchronized byte[] lindex(byte[] key, int index) {
            Jedis sjedis = getJedis();
         ...
         * @return 记录总数
         */
        public synchronized long rpush(byte[] key, byte[] value) {
            Jedis jedis = getJedis();
            long count = jedis.rpush(key, value);
            closeJedis(jedis);
            return count;
         ...
         * @return 记录总数
         */
        public synchronized long lpush(byte[] key, byte[] value) {
            Jedis jedis = getJedis();
         ...
         * @return List
         */
        public synchronized List<byte[]> lrange(byte[] key, int start, int end) {
            // ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
         ...
         */
        public synchronized long lrem(byte[] key, int c, byte[] value) {
            Jedis jedis = getJedis();
         ...
         * @return 删除后的List中的记录数
         */
        public synchronized long lrem(String key, int c, String value) {
         ...
         * @return 执行状态码
         */
        public synchronized String ltrim(byte[] key, int start, int end) {
            Jedis jedis = getJedis();
